...
void Base_parameter_init(void)
{
	...
	Motor_init.voltage_sensor_align=0.8;    //V alignSensor() use it，大功率电机设置的值小一点比如0.5-1，小电机设置的大一点比如2-3
	Motor_init.voltage_limit=8;           //V，主要为限制电机最大电流，最大值需小于12/1.732=6.9
